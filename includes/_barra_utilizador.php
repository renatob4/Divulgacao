...
<div class="barra_utilizador navbar-fixed-top">
    <nav class="navbar navbar-expand-sm p-1 mr-1 ml-1">
        ...
        <div class="navbar-brand pt-1 pb-1 mr-0 ml-3">
        ...
        <div class="collapse navbar-collapse p-0 pb-1" id="navprimary">
            <ul class="navbar-nav ml-auto mr-2 p-0 textm">
                <li class="nav-item mt-2 mb-2"><a class="texto-menu mr-2"><a href="?a=home"><i class="fas fa-home mr-1"></i></a></li>
                <?php if($config[0]['st_product'] == 1):?><li class="nav-item mt-2 mb-2"><a class="texto-menu mr-2"><a href="?a=produtos"><i class="fas fa-shopping-cart mr-1"></i></a></li><?php endif;?>
                <?php if($config[0]['st_service'] == 1):?><li class="nav-item mt-2 mb-2"><a class="texto-menu mr-2"><a href="?a=servicos"><i class="fas fa-wrench mr-1"></i></a></li><?php endif;?>
                <li class="nav-item mt-2 mb-2"><a class="texto-menu mr-2"><a href="?a=contatos"><i class="fas fa-phone mr-1"></i></a></li>
                <?php if($config[0]['st_promotion'] == 1 && $code[0]['lnk_script'] != '' && $code[0]['id_app'] != ''):?><li class="nav-item mt-2 mb-2"><a class="texto-menu mr-2"><a href="?a=promocoes"><i class="fas fa-percentage mr-1"></i></a></li><?php endif;?>
            </ul>
        </div>
    </nav>
</div>